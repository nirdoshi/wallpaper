...
//    public static ArrayList<recyclercontent> arrayurl=new ArrayList<>();
    ...
    public static ArrayList<recyclercontent> travel=new ArrayList<>();
    public static ArrayList<recyclercontent> bikes=new ArrayList<>();
    public static ArrayList<recyclercontent> wildlife=new ArrayList<>();
